...
module.exports = {
    ...
    bots: {
        bot_1: {
            ...
            personaName: ' PUBG Trades BOT #1',   // Nickname for bot account, will change on restart
        },
    },
    ...
    site: {
        header: 'PUBG Trades', // Name/header/title of website. Prefix for  <title></title> (For more: /index.html line: 9) 
        steamGroup: '#',
        copyrights: 'Copyright © PUBG Trades 2017',  // Copyright text
    },
    domain: 'pubgtrades.site',    // Domain name only, follow the example (no http:// & no www & no /)
    website: 'http://pubgtrades.site',    // Website URL, follow the example (do not add / at the end)
    websitePort: 80,    // Website PORT, don't change it unless you're using a reverse proxy
    tradeMessage: 'Trade offer from PUBG Trades | If you did not request this offer or the offer looks invalid please decline.', // Quite obvious
    rates: {
